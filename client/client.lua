...
-- send player to jail
------------------------------------------
RegisterNetEvent('rsg-lawman:client:jailplayer', function(playerId, time, location)
    TriggerServerEvent('rsg-lawman:server:jailplayer', playerId, tonumber(time), location)
end)

RegisterNetEvent('rsg-lawman:client:sendtojail', function(time, location)
    TriggerServerEvent('rsg-lawman:server:sethandcuffstatus', false)
    isHandcuffed = false
    isEscorted = false
    ClearPedTasks(cache.ped)
    DetachEntity(cache.ped, true, false)
    TriggerEvent('rsg-prison:client:Enter', time, location)
end)
------------------------------------------
-- lawman alert
------------------------------------------
